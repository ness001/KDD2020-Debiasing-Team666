...
for topk in [50, 100,500]: #topk=50,100,...500
    ...
    for phase in range(7, now_phase+1):
        ...
        test_df = pd.read_csv('..\\test_data\\test_result_phase-%d.csv' % phase,
                              header=None,
                              names=['user_id', 'item_id', 'txt_sim', 'img_sim', 'itemcf_rank', 'itemcf_score',
                                     'label', 'usercf_rank', 'usercf_score', 'item_heat', 'user_heat', 'score'])
        ...
        with open('..\\test_data\\score_detail.csv', 'a+') as f:
            print('topk={}\npahse={}\nndcg_topk_full={}\nndcg_topk_half={}\nhitrate_topk_full={}\nhitrate_topk_half={}\n'
